<?php
/**
 * Hum, the personal URL shortener.
 *
 * @package Hum
 */
...
class Hum {
	...
	public function init() {
		load_plugin_textdomain( 'hum', null, dirname( plugin_basename( HUM_PLUGIN_FILE ) ) );
	...
	public function enqueue_block_editor_script() {
		...
		$asset_info = include plugin_dir_path( HUM_PLUGIN_FILE ) . 'build/index.asset.php';

		wp_enqueue_script(
			'hum-editor-script',
			plugins_url( 'build/index.js', HUM_PLUGIN_FILE ),
